...
export async function seed(knex: Knex) {
  ...
  await knex('class').insert([
    ...
    { name: 'Tópicos Avançados em Linguagem de Programação' },
  ]);
  ...
  await knex('course_classes').insert([
    ...
    { course_id: 1, class_id: 6, workload: 4, mandatory: 1 },
    { course_id: 1, class_id: 7, workload: 6, mandatory: 0 },
    ...
    { course_id: 2, class_id: 6, workload: 4, mandatory: 1 },
    { course_id: 2, class_id: 7, workload: 4, mandatory: 1 },
    ...
    { course_id: 3, class_id: 6, workload: 6, mandatory: 1 },
    { course_id: 3, class_id: 7, workload: 6, mandatory: 1 },
    ...
    { course_id: 4, class_id: 6, workload: 6, mandatory: 1 },
    { course_id: 4, class_id: 7, workload: 6, mandatory: 1 },
    ...
    { course_id: 5, class_id: 5, workload: 4, mandatory: 0 },
    { course_id: 5, class_id: 6, workload: 6, mandatory: 1 },
    { course_id: 5, class_id: 7, workload: 4, mandatory: 1 },
    ...
    { course_id: 6, class_id: 6, workload: 6, mandatory: 1 },
  ]);
}
